...
import maintenanceImg from "./images/2.avif"; // update to your image
import scrapImg from "./images/3.avif"; // update to your image
import scrapServiceImg from "./images/4.avif"; // update to your image
import industriesBg from "./images/5.webp"; // background image
import industriesVideo from "./images/video.gif";  // front video
const Service = () => {
  return (
    <>
      <Navbar />
        ...
        <div className="maintenance-container">
          ...
          <div className="maintenance-text">
            ...
            <p>
              ...
              measures designed to minimise downtime and extend the lifespan of your
              assets.
            </p>
            <p>
        ...
        <div className="scrap-container">
          ...
          <div className="scrap-text">
            ...
            <p>
              ...
              ensuring that you have access to high-quality materials essential for
              your operations.
            </p>
            <p>
              Our commitment to customer satisfaction drives us to provide not only
              top-notch materials but also exceptional service. Here's how we
        ...
        <div className="scrap-services-container">
          ...
          <div className="scrap-services-text">
            ...
            <p>
              ...
              alike. Recycling Solutions Sustainable recycling options for scrap
              metals, promoting environmental responsibility and resource
              conservation.
            </p>
            <p>
            ...
            <div className="scrap-services-features">
              <div className="feature-box">
                <span>Collection and Bin Services</span>
              </div>
              <div className="feature-box">
                <span>Processing and Sorting</span>
              </div>
              <div className="feature-box">
